[![Run App Tre-Vawn Rainey](https://github.com/Tre-Vawn/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Tre-Vawn/GithubActions/actions/workflows/run-app.yaml)
